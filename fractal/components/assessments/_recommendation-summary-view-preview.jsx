...
const page = ({ rendered_content, path }) => {
    ...
    return (
        <div>
                ...
                <link media="all" rel="stylesheet" href={`http://localhost:3050/static/css/assessments/RecommendationSummaryView/RecommendationSummaryView.css`}/>
            ...
            <script src={`http://localhost:3050/static/js/RecommendationSummaryView.js`}/>
        </div>
    );
};
